...
class ProductDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.loadProduct(arguments?.getString(ARG_PRODUCT_ID).orEmpty())
    }
    ...
    private fun renderProduct(product: Product?, safetyAnswer: String?, riskLevel: String?) {
        ...
        ivProductDetailImage.setImageDrawable(null)
    ...
    private fun renderSafetyResult(
        ...
        tvSafetyDescription.text = safetyAnswer ?: fallbackAnswer
    ...
    private fun createAllergyTagView(text: String): TextView {
        return TextView(requireContext()).apply {
            ...
            setPadding(requireContext().dpToPx(12), 0, requireContext().dpToPx(12), 0)
